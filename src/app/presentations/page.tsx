  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{t('libraryTitle')}</h1>
          <p className="text-lg text-gray-600">{t('librarySubtitle')}</p>
        </div>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500">
                    {t('slideCount', { count: presentation.slides.length })}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  <span>
                    {t('createdOn', {
                      date: new Date(presentation.createdAt).toLocaleDateString('es'),
                    })}
                  </span>
          ...
          >
            <div className="p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-700 group-hover:text-blue-600 transition-colors mb-2">
                {t('createNewCardTitle')}
              </h3>

              <p className="text-gray-500">{t('createNewCardDesc')}</p>
            </div>
          </Link>
        </div>
      </div>
