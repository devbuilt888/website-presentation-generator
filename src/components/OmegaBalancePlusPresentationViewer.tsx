...
export default function OmegaBalancePlusPresentationViewer({ presentation, instanceId }: OmegaBalancePlusPresentationViewerProps) {
  ...
  return (
    <div 
      ref={mobileTapRef}
      className="w-full h-[100dvh] min-h-0 max-h-[100dvh] bg-black flex flex-col overflow-hidden relative"
    >
      ...
      {/* Content area: sin scroll; encaja en viewport */}
      <div className="relative z-10 flex-1 min-h-0 w-full flex items-center justify-center px-3 sm:px-6 pt-1 pb-[calc(4.25rem+env(safe-area-inset-bottom,0px))]">
        ...
        {currentSlide.id === 'slide-7-video1' && (
          <div className="omega-slide-tight text-center text-white animate-fadeIn w-full min-w-0">
            <h1 className="text-4xl font-bold mb-8 drop-shadow-2xl max-w-4xl mx-auto px-1">
              {currentSlide.title}
            </h1>
